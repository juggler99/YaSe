...
class ThemeManager with ChangeNotifier {
  ...
  void changeThemeMode(BuildContext context,
      void Function(VoidCallback) callback, ThemeMode themeMode) {
    callback(() {
  ...
  void onChangeTheme(ThemeData value, int index, String selectedText,
      BuildContext context, void Function(VoidCallback) callback) {
  ...
  Tuple2<bool, String> changeTheme(
      BuildContext context,
      void Function(VoidCallback) callback,
      String outgoingThemeName,
      String incommingThemeName) {
  ...
  State getAppState(State<StatefulWidget> Function(BuildContext) callback) {
    debugger();
    if (_appState == null) {
      _appState = callback(_context!);
    }
    return _appState!;
  }
  ...
  void CreateTheme(
      BuildContext context, void Function(VoidCallback) callback) async {
    print('CreateTheme');
    ...
    if (_availableThemes.containsKey(themeName)) {
      ...
      callback(() {
        changeTheme(context, callback, 'system', themeName);
      });
    }
  }
...
TextTheme generalTextTheme = TextTheme(
  ...
  button: TextStyle(fontSize: 22.0, fontWeight: FontWeight.normal),
);
